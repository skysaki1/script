...
Main:Dropdown("bring mob mode",Nigga,function(value)
    ...
    local AttackList = {"extreme","break your ass","100% no kick"}
_G.FastAttackDelay = "0.5",

    Main:Dropdown("fast attack mode",AttackList,function(Value)
    ...
    spawn(function()
        while wait(.1) do
            if _G.FastAttackDelay then
                pcall(function()
                    if _G.FastAttackDelay == "break your ass" then
                        _G.FastAttackDelay = 0.1
                    elseif _G.FastAttackDelay == "extreme" then
                        _G.FastAttackDelay = 0.2
                    elseif _G.FastAttackDelay == "100% no kick" then
...
spawn(function()
    ...
    spawn(function()
        ...
        Stats:Toggle("melee", function(vu)
            Melee_A = vu
        end)
    
        Stats:Toggle("defense", function(vu)
            Defense_A = vu
        end)
    
        Stats:Toggle("sword", function(vu)
            Sword_A = vu
        end)
    
        Stats:Toggle("gun", function(vu)
            Gun_A = vu
        end)
    
       Stats:Toggle("fruit", function(vu)
            Fruit_A = vu
        end)
    
        Stats:Slider("stat slider", function(vu)
            Points = vu
        end)
        ...
        if World1 then
            ...
            "Fountain City",
            "Shank Room",
            "Mob Island"},_G.SelectIsland, function(Value)
        ...
        "Forgotten Island",
        "Ussop Island",
        "Mini Sky Island"},_G.SelectIsland, function(Value)
            _G.SelectIsland = Value
        end)
    end
    ...
    if World3 then
            ...
            "Cake Island",
            "Cocoa Island",
            "Candy Island"},_G.SelectIsland, function(Value)
                _G.SelectIsland = Value
            end)
        end
